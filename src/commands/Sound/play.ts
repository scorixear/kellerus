...
export default class Play extends AutocompleteInteractionModel {
  constructor() {
    super(
      'play',
      ...
      [
        new SlashCommandStringOption()
          .setName('title')
          .setDescription(LanguageHandler.language.commands.play.options.title)
          .setRequired(true)
          .setAutocomplete(true),
        new SlashCommandStringOption()
          .setName('category')
          .setDescription(LanguageHandler.language.commands.play.options.category)
          .setRequired(false)
      ]
    );
  }
  ...
  override async handle(interaction: ChatInputCommandInteraction) {
    try {
      ...
      Logger.exception('Play Unexpected Error', err, WARNINGLEVEL.ERROR);
      if (
        interaction.member &&
